                    ...
                    <div>
                        ...
                        <div
                            ...
                            <div v-if="genres.length > 0">
                                ...
                                <a :href="route('tag', { type: 'game', slug: tag.slug })" v-for="tag of genres"
                            ...
                            <div v-if="platforms.length > 0">
                                ...
                                <a :href="route('tag', { type: 'game', slug: tag.slug })" v-for="tag of platforms"
                            ...
                            <div v-if="developers.length > 0">
                                ...
                                <a :href="route('tag', { type: 'game', slug: tag.slug })" v-for="tag of developers"
