...
function removeAttached(attachment) {
...
<template>
    ...
    <div class="bg-white rounded p-4 shadow mb-3">
        ...
        <div v-if="creandoPublicacion && attachments" class="grid gap-4 mb-3" :class="[
            ...
            <template v-for="attachment of attachments">
                <div
                    ...
                    <button @click="removeAttached(attachment)"
                        class="absolute right-2 top-2 bg-black/40 hover:bg-black/80 p-1 rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all">
                        <!-- descarga -->
